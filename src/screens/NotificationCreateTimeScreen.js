...
export default function NotificationCreateTimeScreen({ navigation, route }) {
  ...
  const goNext = () => {
    ...
    navigation.navigate("NotificationCreateDuration", {
      draft: {
        ...draft,
        time: value,
      },
  ...
  return (
    <View style={styles.container}>
      <View style={styles.center}>
        <Text style={styles.heading}>Notification Uhrzeit</Text>
