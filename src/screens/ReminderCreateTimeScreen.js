...
export default function ReminderCreateTimeScreen({ navigation, route }) {
  ...
  const goNext = () => {
    ...
    navigation.navigate("ReminderCreateDuration", {
      draft: {
        ...draft,
        time: value,
      },
  ...
  return (
    <View style={styles.container}>
      <View style={styles.center}>
        <Text style={styles.heading}>Reminder Uhrzeit</Text>
        ...
        <Text style={styles.summary}>
          Reminder: {draft.title || "?"} — {draft.date || "?"} — {value || "?"}
        </Text>
      </View>
