...
export default function ReminderCreateDateScreen({ navigation, route }) {
  const [showPicker, setShowPicker] = useState(false);

  const draft = route?.params?.draft ?? { title: "", date: "", time: "", durationSec: null };
  ...
  const goNext = () => {
    ...
    navigation.navigate("ReminderCreateTime", {
      draft: {
        ...draft,
        date: value,
      },
  ...
  return (
    <View style={styles.container}>
      <View style={styles.center}>
        <Text style={styles.heading}>Reminder Datum</Text>
